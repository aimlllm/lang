...
export const translations: Record<Locale, Translations> = {
  zh: {
    ...
    hero: {
      ...
      title2: "匠心品质 值得信赖",
      description:
        "从整体房屋翻新到厨房改造、屋顶修缮和精细装修——凭借多年经验，为湾区每一位客户打造理想家园。",
      cta1: "立即致电咨询",
      cta2: "查看工程案例",
      trust1: "持牌 & 全额保险",
      trust2: "15年以上经验",
    ...
    about: {
      ...
      title1: "以品质赢信赖",
      title2: "用匠心筑家园",
      p1: "我们扎根旧金山湾区超过15年，凭借丰富的实战经验，赢得了优质房屋装修的良好口碑。从整体房屋改造到精细装修，每一个项目都倾注了我们全部的专注与匠心。",
      ...
      items: [
        {
          title: "整体房屋翻新",
          description:
            "从地基到装饰的全面房屋改造。我们把控大型翻修的每一个细节，交付出色的成果，提升您家的价值和居住品质。",
        },
        {
          title: "厨房改造",
          description:
        ...
        },
        {
          title: "卧室改造",
          description:
            "打造您的完美休憩空间。从布局重新设计、嵌入式收纳到灯光和装饰细节，让您的空间独一无二。",
        },
        {
          title: "围栏安装 & 刷墙",
          description:
            "专业的围栏安装和室内外油漆服务。使用优质材料和精湛工艺，为您的房屋带来焕然一新的外观。",
        },
      ],
    },
    ...
    contact: {
      ...
      title2: "装修项目了吗？",
      description:
        "今天就致电联系我们，免费咨询。我们将详细了解您的装修需求，提供专业建议和透明报价，没有任何附加条件。",
      phoneLabel: "电话",
      areaLabel: "服务区域",
      areaValue: "旧金山湾区",
      areasTitle: "服务覆盖城市",
